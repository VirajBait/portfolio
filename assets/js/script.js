...
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        // Replace the values below with your own SMTP settings
        Email.send({
            SecureToken: 'dc3a5512-c020-49d9-86fd-900f308655a5',
            To: 'biradivishwanath@gmail.com',
            From: 'vishubiradi696@gmail.com',
